...
interface Env { DB:D1Database; ASSETS:Fetcher; APP_NAME:string; APP_URL:string; APP_TIMEZONE:string; NOTIFY_MODE:string; ENVIRONMENT:string; LINE_CHANNEL_SECRET:string; LINE_CHANNEL_ID:string; LINE_LIFF_ID:string; LINE_ACCESS_TOKEN:string; APP_SECRET:string; NOTIFY_SECRET:string; VAPID_PUBLIC_KEY?:string; VAPID_PRIVATE_KEY?:string; VAPID_SUBJECT?:string; GOOGLE_HOME_CLIENT_ID?:string; GOOGLE_HOME_CLIENT_SECRET?:string; GOOGLE_HOME_REDIRECT_URI?:string; }
