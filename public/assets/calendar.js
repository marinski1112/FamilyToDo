...
try {
  ...
  monthPicker?.addEventListener('change',()=>{const value=String(monthPicker.value||'');if(!/^(?:20\d{2}|2100)-(?:0[1-9]|1[0-2])$/.test(value)||value===currentMonth)return;loadMonth(value,value>currentMonth?1:-1);});
