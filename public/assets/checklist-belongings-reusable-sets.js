...
const boot=()=>{
  ...
  const render=()=>{
    ...
    for(const set of sets){
      ...
      const add=document.createElement('button');add.type='button';add.className='belongings-set-add';add.textContent='追加';add.addEventListener('click',()=>void invoke(set,add));actions.append(add);
