...
try{
  ...
  async function createChildTask(){
    ...
    const body={csrf,title,description:'',is_event:false,is_private:childState.parentVisibility==='PRIVATE',dateOnly:dueDate,endDateOnly:dueDate,noDate:!dueDate,allDay:!dueTime,startTime:dueTime,endTime:'',location:'',calendar_visible:true,completion_mode:completion,assignees:childAssignees,reminderAt:'',parent_task_id:parentId};
