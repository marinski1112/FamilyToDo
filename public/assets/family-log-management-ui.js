(()=>{
'use strict';
const compactScript=document.createElement('script');compactScript.src='/assets/family-log-compact-ui.js?v=compact2';compactScript.defer=true;document.head.appendChild(compactScript);
try{
