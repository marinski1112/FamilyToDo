...
try{
  ...
  f.addEventListener('submit',async e=>{
    ...
    b.family_log_enabled=Boolean(q('family_log_enabled')?.checked);b.all_day=Boolean(q('all_day')?.checked);b.calendar_visible=Boolean(q('calendar_visible')?.checked);b.calendar_color=q('calendar_color')?.value||'#7c3aed';
