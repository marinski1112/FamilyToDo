...
assert.match(sw,/familytodo-static-wave128-fix3/,'static cache must rotate for fix3');

console.log('wave128 fix3 smoke: event fallback, Google Calendar safety guidance, cache rotation ok');
