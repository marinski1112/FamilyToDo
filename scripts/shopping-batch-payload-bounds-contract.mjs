...
console.log('shopping batch payload bounds contract: product count and per-product text are bounded before request assembly/network I/O while existing URL/entity safety remains intact');
