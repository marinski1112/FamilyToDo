...
console.log('rough-input AI cost guard contract: deterministic-first, safe ISO due extraction, continuation temporal eligibility, durable budgets, date-independent 429 circuit, and bounded model calls ok');
