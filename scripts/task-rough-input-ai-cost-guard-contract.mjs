...
console.log('rough-input AI cost guard contract: deterministic-first, explicit ISO due dates, continuation temporal ambiguity, durable budgets, date-independent 429 circuit, and bounded model calls ok');