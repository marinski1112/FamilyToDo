...
assert.equal(pkg.version,'12.139.0-wave120');
...
assert.ok(!liff.includes('googleHome'));assert.ok(!liff.includes('auth-health'));assert.ok(liff.indexOf('await window.liff.init')<liff.indexOf('current=runtime()'));
