...
assert.match(wrapper,/PIYOLOG_IMPORT_ASSET='\/assets\/family-log-import-piyolog\.js\?v=piyolog-family-diary1'/,'Piyolog controller must be cache-busted after media diagnostic behavior changes');
