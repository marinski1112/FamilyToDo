...
console.log('google-tasks-voice-contract: bounded Google Tasks sync, private projection guards, typed task/shopping creation and completion, family-log voice bridge, inquiry-safe member Web Push foundation, schema uniqueness, and voice-import semantics ok');
