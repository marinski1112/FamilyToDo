...
console.log('google-tasks-voice-contract: bounded Google Tasks sync, private projection guards, typed task creation/completion, family-log voice bridge, schema uniqueness, and voice-import semantics ok');
