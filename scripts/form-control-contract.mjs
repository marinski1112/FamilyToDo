...
for(const marker of ['date-option-row date-range-grid task-date-row','date-option-row date-range-grid'])if(!app.includes(marker))throw Error('missing task date pair marker '+marker);
