...
for(const transitional of ['settings','settingsContent','settingsDiagnostics','settingsNotifications','recurring']) if(!new RegExp(`\\b${transitional}\\b`).test(appExport)) throw new Error(`${transitional} transition boundary moved unexpectedly`);
