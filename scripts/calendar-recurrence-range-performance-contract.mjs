...
if(range.includes('SELECT * FROM recurrence_occurrences WHERE family_id=? AND occurrence_date BETWEEN ? AND ?'))throw new Error('widened occurrence reads must be scoped to projected recurrence rules');
