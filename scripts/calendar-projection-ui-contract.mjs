...
assert.match(sw,/familytodo-static-wave128-fix\d+/,'static cache must retain the established safe-fix namespace until runtime cache rotation is intentionally changed');
