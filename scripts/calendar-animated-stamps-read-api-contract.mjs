...
console.log('calendar animated stamps read API + month-cell consumer contract: bounded sequential PNG playback, safe storage resolution, editable placement projection, picker/create/update/delete placement API flow and legacy GIF/WebP fallback ok');
