...
assert.equal((await context.module.exports.archiveLocationHistory({DB:adapter})).length,0,'already archived day is not repaired repeatedly');
db.close();
console.log('journal archive overflow: full 2672-point day is archived once with a bounded route');
