...
assert.match(familyLoader,/family-log-core\.js\?v=wave128-quick-diag1-photo1/,'Family Log loader must preserve the existing core implementation with the refreshed cache key');
