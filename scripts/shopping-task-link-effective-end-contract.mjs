...
assert.match(checklist,/s\.due_date IS NULL[\s\S]{0,100}s\.status<>'completed'/,'pending independent shopping without a deadline must remain continuously visible');
