...
assert.ok(['12.143.0-wave124','12.140.0-wave121','12.141.0-wave122','12.142.0-wave123'].includes(pkg.version));assert.ok(types.includes('LINE_LOGIN_CHANNEL_ID?:string')&&types.includes('LINE_LOGIN_CHANNEL_SECRET?:string'));
