...
const checks=[
  ...
  [archive.includes("ARCHIVE_REBUILD_FROM_LOCAL_DATE='2026-09-14'")&&archive.includes("ARCHIVE_REBUILD_BEFORE='2026-09-25T14:00:00Z'")&&archive.includes('a.archived_at<?')&&archive.includes('rebuildIncompleteArchivedDays'),'incomplete pre-fix archived days from 9/14 are eligible for one-shot bounded rebuild'],
