...
const checks=[
  ...
  [archive.includes("ARCHIVE_REBUILD_FROM_LOCAL_DATE='2026-09-14'")&&archive.includes('rebuildIncompleteArchivedDays'),'incomplete archived days from 9/14 are eligible for bounded rebuild'],
