...
if(!count)throw Error('audit found no temporal controls');console.log(`wave123 form audit ok: ${count} date/time/datetime-local inputs across ${files.length} source files`);
