...
assert.match(pkg.version,/^12\.(?:128|129)\.0-wave(?:109|110)$/);
assert.match(source,/ICS_APPLY_CHUNK=(?:10|20)/);assert.match(source,/ICS_ROLLBACK_CHUNK=(?:15|20)/);assert.match(source,/ICS_MAX_EXDATES=4/);
