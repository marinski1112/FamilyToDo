...
assert.equal(pkg.version,'12.132.0-wave113');
...
assert.match(home,/SCENE_NAME_MAX=80/);assert.match(home,/normalize\('NFKC'\)/);assert.match(home,/Google Homeで同名の操作があります/);assert.match(home,/slice\(0,10\)/);
