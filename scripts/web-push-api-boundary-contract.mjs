...
for(const transitional of ['toggle','shopping','familyLog','settings']) if(!new RegExp(`\\b${transitional}\\b`).test(appImport)) throw new Error(`${transitional} transition boundary moved unexpectedly`);
