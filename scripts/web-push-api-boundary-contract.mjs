...
for(const transitional of ['joinFamily','inviteCreate','toggle','messages','shopping','familyLog','recordOccurrenceFamilyLog','settings']) if(!new RegExp(`\\b${transitional}\\b`).test(appImport)) throw new Error(`${transitional} transition boundary moved unexpectedly`);
