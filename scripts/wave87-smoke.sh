...
set -euo pipefail
node <<'JS'
const fs=require('fs'),app=fs.readFileSync('src/app.ts','utf8'),js=fs.readFileSync('public/assets/task-events.js','utf8'),fl=[fs.readFileSync('public/assets/family-log.js','utf8'),fs.existsSync('public/assets/family-log-core.js')?fs.readFileSync('public/assets/family-log-core.js','utf8'):''].join('\n'),css=fs.readFileSync('public/assets/family.css','utf8'),mig=fs.readFileSync('migrations/0024_wave87_custom_timer.sql','utf8');
