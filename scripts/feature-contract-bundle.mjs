...
const groups={
  'calendar-imports':[
    ...
    ['calendar-animated-stamps-layout',['node','scripts/calendar-animated-stamps-layout-contract.mjs']],
  ...
  'google-integrations':[
    ...
    ['google-voice-inquiry-push',['node','scripts/google-voice-inquiry-push-contract.mjs']],
  ...
  'ui-product':[
    ...
    ['shopping-payload-bootstrap-safety',['node','scripts/shopping-payload-bootstrap-safety-contract.mjs']],
    ...
    ['web-push-tenant-integrity',['node','scripts/web-push-tenant-integrity-contract.mjs']],
