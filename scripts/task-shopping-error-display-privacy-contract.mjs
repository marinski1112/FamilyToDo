...
assert.doesNotMatch(taskCreate+taskEdit,/calendar_perf|CHILD_JOURNAL|CHILD_MILESTONE|OwnTracks|geofence/i,'Task/Shopping error hardening must remain isolated from deferred Calendar/Child Journal/location work');
