...
if(!shell.includes('checklist-category-followup.js?v=${APP_VERSION}-category-followup6'))throw new Error('Shopping continuous-entry UX must use a fresh asset revision');
