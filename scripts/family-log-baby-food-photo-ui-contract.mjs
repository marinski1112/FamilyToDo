...
assert.ok(shell.includes("FAMILY_LOG_UI_REVISION = 'baby-food-photo2-observer1-form2'")&&shell.includes('FAMILY_LOG_UI_REVISION}`'),'outer Family Log cache revision is missing');
