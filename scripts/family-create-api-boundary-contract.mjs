...
for(const marker of [
  ...
  'INSERT INTO members(family_id,line_user_id,name,member_type,role,notification_enabled,active,created_at,updated_at,line_picture_url) VALUES(?,?,?,?,?,?,?,?,?,?)',
  'ctx.session.linePictureUrl||null',
