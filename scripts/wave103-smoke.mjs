...
assert.equal(pkg.version,'12.122.0-wave103');
...
for(const category of ['NOT_CONFIGURED','INVALID_API_KEY','MODEL_NOT_FOUND','RATE_LIMITED','UPSTREAM_UNAVAILABLE','UNKNOWN'])assert.ok(ai.includes(category));
