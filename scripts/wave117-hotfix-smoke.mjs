...
const app=read('src/app.ts');assert.ok(app.includes('validateLiffNext(body.next)'));assert.match(app,/12\.(?:143\.0-wave124|13(?:6\.1-wave117-hotfix|7\.0-wave118|8\.0-wave119|9\.0-wave120)|140\.0-wave121|141\.0-wave122|142\.0-wave123)/);
