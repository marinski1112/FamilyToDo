...
if(!['12.120.0-wave101','12.121.0-wave102','12.122.0-wave103','12.123.0-wave104','12.124.0-wave105','12.125.0-wave106','12.126.0-wave107','12.127.0-wave108','12.128.0-wave109','12.129.0-wave110','12.130.0-wave111','12.131.0-wave112'].includes(pkg.version))throw Error('version mismatch');
