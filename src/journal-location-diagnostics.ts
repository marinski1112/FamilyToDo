...
export async function journalLocationDiagnostics(request:Request,ctx:AppContext):Promise<Response>{
  ...
  const [archive,stays,journal]=await Promise.all([
