...
export async function settingsLocation(_request:Request,ctx:AppContext):Promise<Response>{
  ...
  <script src="/assets/settings-location.js?v=${APP_VERSION}-home1"></script><script src="/assets/location-places.js?v=arrival1"></script>`;
