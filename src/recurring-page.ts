    ...
    if(request.method==='POST'){
      ...
      if(action==='delete'){
        ...
        if(taskId){
          ...
          statements.push(
            ctx.env.DB.prepare('DELETE FROM task_assignees WHERE task_id=?').bind(taskId),
