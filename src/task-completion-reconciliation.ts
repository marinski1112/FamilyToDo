 ...
 *
 * Shopping and belongings are intentionally absent here. Their completion state is
 * owned by each goods row and must not be rewritten when task/member assignments change.
 */
