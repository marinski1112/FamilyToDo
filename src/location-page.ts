...
export async function locationPage(_request:Request,ctx:AppContext,env:Env):Promise<Response>{
  ...
  const body=`<style>
    .location-map-card{padding:0;overflow:hidden;position:relative;background:#fff}.location-map-head{position:absolute;z-index:4;top:12px;left:12px;right:12px;display:flex;justify-content:space-between;gap:12px;align-items:flex-start;padding:13px 14px;background:rgba(255,255,255,.94);border:1px solid rgba(226,232,240,.9);border-radius:20px;box-shadow:0 8px 28px rgba(15,23,42,.14);backdrop-filter:blur(12px);-webkit-backdrop-filter:blur(12px)}.location-map-head h2{margin:0}.location-map-head-actions{display:flex;gap:8px;align-items:center;flex-wrap:wrap;justify-content:flex-end}.location-refresh{flex:0 0 auto}.location-refresh[disabled]{opacity:.55;cursor:wait}.location-home-eta-result{font-size:12px;color:#475569;max-width:180px;text-align:right}.location-map-surface{height:clamp(480px,62dvh,720px);min-height:480px;position:relative;background:linear-gradient(145deg,#eef2ff,#f8fafc)}.location-map-canvas{width:100%;height:100%;min-height:100%}.location-map-placeholder{height:100%;min-height:100%;display:grid;place-items:center;padding:24px;text-align:center}.location-map-placeholder-inner{max-width:420px}.location-map-icon{font-size:40px;line-height:1;margin-bottom:10px}.location-list{position:relative;z-index:3;display:grid;gap:0;margin:-26px 10px 0;padding-top:12px;background:#fff;border-radius:24px 24px 0 0;box-shadow:0 -10px 30px rgba(15,23,42,.12);overflow:hidden}.location-list::before{content:'';display:block;width:42px;height:4px;border-radius:999px;background:#d7dce5;margin:0 auto 8px}.location-member-row{display:grid;grid-template-columns:42px minmax(0,1fr) auto;gap:10px;align-items:center;padding:12px 16px;border-top:1px solid #eef2f7}.location-avatar-fallback{width:38px;height:38px;border-radius:50%;display:grid;place-items:center;background:#e0e7ff;font-weight:700;color:#3730a3}.location-member-name{display:block;overflow:hidden;text-overflow:ellipsis;white-space:nowrap}.location-member-meta{margin-top:2px}.location-member-actions{display:flex;flex-wrap:wrap;gap:8px;align-items:center;margin-top:7px}.location-eta-result{font-size:12px;color:#475569}.location-state-badge{font-size:12px;border-radius:999px;padding:4px 8px;background:#eef2ff;color:#3730a3;white-space:nowrap}.location-member-row[data-state="AGING"] .location-state-badge{background:#fff7ed;color:#9a3412}.location-member-row[data-state="STALE"]{opacity:.68}.location-member-row[data-state="STALE"] .location-state-badge{background:#f3f4f6;color:#4b5563}.location-member-row[data-state="SHARING_OFF"] .location-state-badge,.location-member-row[data-state="NO_LOCATION"] .location-state-badge{background:#f3f4f6;color:#6b7280}.location-empty{padding:18px 16px;color:#6b7280}.location-map-note{padding:10px 16px 14px}.location-secondary{margin-top:14px}.location-map-provider-note{font-size:12px;color:#64748b;margin-top:8px}.location-history-controls{display:flex;gap:8px;align-items:center;flex-wrap:wrap;margin-top:10px}.location-history-controls select{min-width:150px;max-width:100%}.location-history-links{display:flex;gap:8px;flex-wrap:wrap;margin-top:10px}.location-history-summary{margin-top:8px}@media(max-width:560px){.location-map-head{top:10px;left:10px;right:10px;padding:12px;display:block}.location-map-head-actions{justify-content:flex-start;margin-top:9px}.location-home-eta-result{text-align:left;max-width:none}.location-map-surface{height:clamp(500px,64dvh,680px);min-height:500px}.location-map-placeholder{padding:18px}.location-list{margin-top:-28px;margin-left:8px;margin-right:8px;border-radius:24px 24px 0 0}.location-member-row{grid-template-columns:38px minmax(0,1fr);padding:11px 14px}.location-state-badge{grid-column:2;justify-self:start}.location-avatar-fallback{width:34px;height:34px}.location-history-controls{align-items:stretch}.location-history-controls select,.location-history-controls button{width:100%}}
  </style>
