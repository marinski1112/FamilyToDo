...
const EXACT_INQUIRIES:ReadonlyArray<readonly [GoogleVoiceInquiryKind,ReadonlySet<string>]>= [
  ...
  ['TOMORROW_SCHEDULE',new Set(['明日の予定','明日のタスク','明日のTODO','明日予定','明日タスク','明日の予定教えて','明日の予定を教えて','明日の予定は','明日のタスク教えて','明日のタスクを教えて','明日のタスクは','明日何する'])],
  ['OPEN_SHOPPING',new Set(['買い物リスト','買うもの','未完了の買い物','買い物教えて','買い物を教えて','買い物リスト教えて','買い物リストを教えて','買い物リストは','買うもの教えて','買うものを教えて','買うものは','買い物何がある'])],
];
