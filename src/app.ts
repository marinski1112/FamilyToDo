...
export async function familyLog(request:Request,ctx:AppContext):Promise<Response>{
  ...
  const aiEntry=!managementMode?`<details class="family-ai-query"><summary>✨ 家族データに聞く</summary><form id="familyAiForm"><input name="question" maxlength="500" placeholder="例：今月家事を一番多くした人は？" required><button type="submit">聞く</button></form><div id="familyAiAnswer" class="small" aria-live="polite"></div></details><script src="/assets/family-ai.js?v=12.120-wave101"></script>`:'';
