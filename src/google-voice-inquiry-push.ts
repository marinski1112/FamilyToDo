...
const META: Record<GoogleVoiceInquiryKind,{title:string;empty:string;url:string;tag:string}> = {
  TODAY_SCHEDULE: {title:'今日の予定',empty:'今日の予定はありません。',url:'/app/today.php',tag:'familytodo-inquiry-today'},
  TOMORROW_SCHEDULE: {title:'明日の予定',empty:'明日の予定はありません。',url:'/app/tomorrow.php',tag:'familytodo-inquiry-tomorrow'},
