...
/**
 * Canonical retained completion service for Family Log linked Task/recurrence targets.
 * The caller remains responsible for authentication, CSRF, and validating the Family Log input.
 * This service preserves the existing tenant, assignee, ANY/ALL, history, notification, and
 * activity-log semantics without depending on the legacy app.ts monolith.
 */
