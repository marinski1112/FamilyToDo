...
export async function home(ctx:AppContext):Promise<Response>{
  ...
  const alertLinks=[
    ...
    dashboard.overdueShopping>0?`<a class="home-alert danger" href="/app/tasks.php?date=${dashboard.today}#shopping-checklist"><span>🛒</span><strong>期限切れ買い物 ${dashboard.overdueShopping}件</strong><small>確認する</small></a>`:'',
