...
export function layout(title: string, body: string, active = ''): string {
  ...
  const checklistExtra=active==='/app/tasks.php'?`<link rel="stylesheet" href="/assets/checklist-reminders.css?v=${APP_VERSION}-reminders3"><script defer src="/assets/checklist-reminders-ui.js?v=${APP_VERSION}-reminders3"></script><script defer src="/assets/checklist-reminders-flow-fix.js?v=${APP_VERSION}-enter1"></script>`:'';
