...
const LOCATION_UI_REVISION = 'home-presence1';
...
export function layout(title: string, body: string, active = ''): string {
  ...
  const locationDiagnosticsExtra=active==='/app/location.php'?`<script defer src="/assets/location-maps-diagnostics.js?v=${APP_VERSION}-maps-diagnostics2"></script>`:'';
