...
export function layout(title: string, body: string, active = ''): string {
  ...
  const checklistExtra=active==='/app/tasks.php'?`<link rel="stylesheet" href="/assets/checklist-reminders.css?v=${APP_VERSION}-reminders1"><script defer src="/assets/checklist-reminders-ui.js?v=${APP_VERSION}-reminders1"></script>`:'';
