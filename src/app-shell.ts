...
const FAMILY_LOG_UI_REVISION = 'baby-food-photo2-observer1-form2-dock1';
...
export function layout(title: string, body: string, active = ''): string {
  ...
  const familyLogExtra=active==='/app/family_log.php'?`<link rel="stylesheet" href="/assets/family-log-layout.css?v=${APP_VERSION}-mobile2"><script defer src="/assets/family-log-success-recovery.js?v=${APP_VERSION}-post-save1"></script><script defer src="/assets/family-journal-link.js?v=${APP_VERSION}-journal1"></script>`:'';
