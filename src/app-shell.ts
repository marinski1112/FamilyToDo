...
export function layout(title: string, body: string, active = ''): string {
  ...
  const locationExtra=active==='/app/location.php'?`<script defer src="/assets/location.js?v=${APP_VERSION}-${LOCATION_UI_REVISION}"></script><script defer src="/assets/location-marker-presence.js?v=${APP_VERSION}-marker-presence2"></script><script defer src="/assets/location-retention-copy.js?v=${APP_VERSION}-raw-maintenance1"></script>`:'';
