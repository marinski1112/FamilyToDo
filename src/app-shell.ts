...
export function layout(title: string, body: string, active = ''): string {
  ...
  const calendarExtra=active==='/app/calendar.php'?`<link rel="stylesheet" href="/assets/calendar.css?v=${APP_VERSION}"><script defer src="/assets/calendar-stamp-ui.js?v=${APP_VERSION}-${CALENDAR_STAMP_UI_REVISION}"></script><script defer src="/assets/calendar-day-inline.js?v=${APP_VERSION}-day-inline1"></script>`:'';
