...
PDFの日記欄や「立った」「ママと言った」等の成長記録は、次の形式にします。通常ログと成長日記へ二重に作らず、1レコードだけ作ってください。このレコードは家族日誌の「育児日記」欄に表示され、家族ログ・成長日記の一覧からは除外されます。保存済みの同形式の日記も、本文・日付・写真を変えずに同じ表示先になります。
